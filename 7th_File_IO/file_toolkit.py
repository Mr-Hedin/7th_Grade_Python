"""
This file contains a set of functions we can use to create an interactive program 
to record a log of thoughts, data, or other information you'd like to save for later.
"""
import os
